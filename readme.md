# React Native FinTech Clone

This is a React Native FinTech clone using for user authentication with OTP. This app was inspired by the [Revolut](https://www.revolut.com/) app.
